...
import Photo1 from "../../../assets/images/TougeChime/chime.png"
...
function PowerbanderApp() {
    return (
      ...
      title={"Touge Chime"} link={"https://github.com/Kyrylo234/TougeChime"} desc={"A mechanical chime device recreating the iconic Toyota AE86 'speeding chime', powered by an ESP32. Designed, built, and sold independently — from firmware to Bluetooth app to 3D store."}/>
    )
  }
