...
function ImageToSTL() {
    return (
      ...
      title={"Image To STL Converter"} link={"https://github.com/Kyrylo234/image_to_stl"} desc={"Python tool that converts 2D raster images into 3D printable STL mesh models via heightmaps."}/>
    )
  }
